...
\paragraph{SMT}
Marginal gain from 12 to 24 threads ($\approx 11\times$ to $\approx 11.5\times$) confirms the workload is compute-bound on physical cores; hyperthreading only helps hide remaining pipeline stalls rather than adding throughput.


More deeper analysis were performed inside the \cref{subsec:deeper_parallel}.
\begin{figure*}
    \begin{center}
        \centering
